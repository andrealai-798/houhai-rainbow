...
如果在知识点之后还要继续补充解释、建议或过渡语，必须先使用合适的中文标点将知识点与后续文字分开，绝不能把老师知识点的最后一个字与后面的文字直接连在一起。
每一类具体问题反馈结束时，要用完整的句号“。”收束，再进入下一类问题或练习建议。可以在同一类多个知识点之间使用顿号、逗号或分号，但整类问题结束后必须有句号。
